...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-electric-500/10 bg-void-950/50">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-xs mb-4">
              {PERSONAL_INFO.title} crafting AI-powered solutions with
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-electric-500/20 to-transparent my-8" />
      ...
      {/* Background gradient */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-px bg-gradient-to-r from-transparent via-electric-500/30 to-transparent" />
    </footer>
  );
}
